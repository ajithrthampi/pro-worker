...
import { about_hero, blog1 } from "@/assets";
  ...
  const blog_data = [
    {
      ...
      description:
        "A clogged drain has an obstacle of some sort in the pipe. Needs something to dislodge or force the blockage out. You could use a plumber and remain within your parameters.",
    },
    {
      date: "May 12th",
      blogImage_url:
  ...
  return (
    ...
    >
      ...
      <div className="lg:h-scree md:h-[600px md:pt-20 pt10 bg-[#011751]  w-full flex-col flex justify-center items-center h-full  sm:pt-10">
        <div className="flex md:flex-row flex-col lg:gap-20 gap- lg:max-w-[1490px] hmd:max-w-[890px] md:max-w-[790px] max-w-[590px] md:px-10 px-5 w-full">
          <div className="flex flex-col md:pb-20 pb-10 sm:justify-center sm:pt-0 pt-10 h-full gap-[31px]  ">
            ...
            <input
              className="border-b mt-10  border-[#5e89ff] bg-transparent placeholder:font-primaryRegular font-primaryRegular text-base pb-1 w-full outline-none "
              placeholder="Enter your email"
            />
            <div className="">
              <button className="bg-[#1D47B8] font-primaryBold md:px-10 px-5 md:mt-5 md:rounded-[10px] rounded md:py-6 sm:py-3 py-2  border text-white md:text-3xl sm:text-base text-sm font-bold">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className=" w-full flex-col flex justify-center items-center h-full  pt-6">
        <div className=" lg:max-w-[1490px] hmd:max-w-[890px] md:max-w-[790px] max-w-[590px] md:px-10 px-5 w-full h-fu">
          <div className="flex xlg:flex-row flex-col  items-start md:gap-10 pt-[40px] overflow-hidden ">
            <section className="xlg:w-[65%] borde rounded-lg pb-10  ">
              <div className="md:grid md:grid-cols-2 hmd:grid-cols-2 xlg:grid-cols-2 gap-5  flex overflow-x-scroll">
                {blog_data.map((item, index) => (
                  <div
                    className="border rounded-xl lxs:max-w-xs xxs:max-w-[300px] max-w-[250px] flex-shrink-0 md:max-w-full cursor-pointer"
                  ...
                  >
                    ...
                    <img
                      className="rounded-t-xl md:h-[300px] h-[200px] w-full object-cover"
                      src={item.blogImage_url}
                      alt=""
                    />
                    <div className="lg:text-[26px] md:text-[20px] text-[18px] md:pt-10 md:p-6 p-4 w-full ">
                      <p className="font-primaryBold"> {item.heading}</p>
                      <p className="font-primaryRegular md:text-[17px] text-[12px] md:mt-5 mt-2">
                        {item.description}
                      </p>
                      <div className="font-primaryRegular text-sm text-[#1D47B8] flex flex-col items-end pt-5">
                        <p className="flex items-center gap-2 md:text-[17px] text-[12px] cursor-pointer">
              ...
              {/* <div className="grid xlg:grid-cols-2 hmd:grid-cols-2 grid-cols-1 gap-5 ">
                {blog_data.map((item, index) => (
                  <div className="border rounded-xl w-full" key={index}>
                    <img
                      className="rounded-t-xl h-[300px] w-full object-cover"
                      src={item.blogImage_url}
                      alt=""
                    />
                    <div className="lg:text-[26px] md:text-[20px] text-[18px] md:pt-10 md:p-6 p-4 w-full ">
